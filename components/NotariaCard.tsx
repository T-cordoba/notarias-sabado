          ...
          return url ? (
            <>
              <a
                ...
                className="flex items-center justify-center gap-2 w-full bg-emerald-700 hover:bg-emerald-800 active:bg-emerald-900 text-white text-sm font-semibold py-2.5 rounded-xl transition-colors"
              >
